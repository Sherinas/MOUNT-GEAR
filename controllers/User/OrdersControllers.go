...
func Invoice(c *gin.Context) {
	...
	pdf.SetXY(140, 35)
	pdf.SetXY(10, 20)
	pdf.CellFormat(160, 60, "MOUND GEAR", "", 0, "R", false, 0, "")
	pdf.Ln(5)

	pdf.SetFont("Arial", "", 12)
	pdf.Cell(40, 10, "Invoice No: INV-"+orderID)
	pdf.Ln(5)
	...
	pdf.Ln(10)
	pdf.Cell(40, 10, "Number: "+address.AddressPhone)
	pdf.Ln(10)

	pdf.Cell(40, 10, "Billing Address:")
	pdf.Ln(5)
	pdf.Cell(40, 10, address.AddressLine1)
	pdf.Ln(5)
	pdf.Cell(40, 10, address.AddressLine2)
	pdf.Ln(5)
	pdf.Cell(40, 10, address.City)
	pdf.Ln(5)
	pdf.Cell(40, 10, address.State+", "+address.Country+" "+address.Zipcode)
	pdf.Ln(10)
	...
	for _, item := range order.Items {
		...
		itemTotal := product.Price * float64(item.Quantity)
		pdf.SetFont("Arial", "", 12)
		pdf.CellFormat(70, 10, product.Name, "1", 0, "", false, 0, "")
		pdf.CellFormat(40, 10, strconv.Itoa(item.Quantity), "1", 0, "C", false, 0, "")
		pdf.CellFormat(40, 10, fmt.Sprintf("%.2f", product.Price), "1", 0, "C", false, 0, "")
		pdf.CellFormat(40, 10, fmt.Sprintf("%.2f", itemTotal), "1", 0, "C", false, 0, "")
		pdf.Ln(10)
	}
	...
	pdf.CellFormat(150, 10, "Coupon Discount:", "", 0, "R", false, 0, "")
	pdf.Cell(40, 10, fmt.Sprintf("%.2f", order.CouponDiscount))
	pdf.Ln(5)

	pdf.CellFormat(150, 10, "Offer Discount:", "", 0, "R", false, 0, "")
	pdf.Cell(40, 10, fmt.Sprintf("-%.2f", order.OfferDicount))
	pdf.Ln(5)

	pdf.CellFormat(150, 10, "Total Discount:", "", 0, "R", false, 0, "")
	...
	c.Writer.Header().Set("Content-Disposition", "attachment; filename=invoice.pdf")
